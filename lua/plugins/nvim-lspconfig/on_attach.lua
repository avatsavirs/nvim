...
local set_lsp_keybindings = function (_, buffer_number)
  ...
  vim.api.nvim_buf_set_keymap(buffer_number, 'n', '[d', '<cmd>lua vim.diagnostic.goto_prev()<CR>', opts)
  vim.api.nvim_buf_set_keymap(buffer_number, 'n', ']d', '<cmd>lua vim.diagnostic.goto_next()<CR>', opts)
  vim.api.nvim_buf_set_keymap(buffer_number, 'n', ']]', '<cmd>lua vim.diagnostic.open_float()<CR>', opts)
end
